  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete it?") === true) {
      await deleteApi("graph", id)
        ...
        .catch((err) => toast.error("Failed to delete the graph."));
    }
  };
    ...
    <div>
      ...
      <div className="content-wrapper pt-4">
        <div className="contentofpages">
          ...
          <h4 className="page-title">• View All Biological Information</h4>
                    ...
                    {data && data.length > 0 ? (
                      data.map((item, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            <Link
                              to={`/ViewBiologicalInformation?id=${item._id}`}
                            >
                              <OverlayTrigger
                          ...
                          <td>
                            <Link
                              to={`/EditBiologicalInformation?id=${item._id}`}
                            >
                              <OverlayTrigger
                                delay={{ hide: 450, show: 300 }}
                                overlay={(props) => (
...
export default ViewAllBiologicalInformation;
