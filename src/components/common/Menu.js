            ...
            >
              ...
              <li className="nav-item has-treeview borders">
                <Link to="/Dashboard" className="nav-link main">
                  ...
                  &nbsp;&nbsp;&nbsp;
                  <p>
                    Panel <i className="fas fa-angle-right right" />
                  </p>
                </Link>
                <ul className="nav nav-treeview dots">
                  <NavLink className="naav" to="/Dashboard">
                    <li className="nav-item">
                      <i className="fa fa-circle" aria-hidden="true"></i> Menu 1
                    </li>
                  </NavLink>
                  <NavLink className="naav" to="/Dashboard">
                    <li className="nav-item">
                      <i className="fa fa-circle" aria-hidden="true"></i> Menu 2
                    </li>
                  </NavLink>
                  <NavLink className="naav" to="/Dashboard">
                    <li className="nav-item">
                      <i className="fa fa-circle" aria-hidden="true"></i> Menu 3
                    </li>
                  </NavLink>
                </ul>
              </li>
